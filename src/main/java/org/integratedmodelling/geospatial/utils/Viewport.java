...
public class Viewport {
  ...
  /**
   * Get the size fitting this viewport for an image with the specified width and height, which can
   * be in any scale. Aspect ratio is preserved throughout.
   *
   * @param imageWidth
   * @param imageHeight
  ...
  /**
   * Define the plot size for the given map dimensions that ensures that a map drawing of the area
   * fits maximally within a viewport.
   *
   * @param viewportWidth
  ...
  public static int[] getViewportSize(
      int viewportWidth, int viewportHeight, Number mapWidth, Number mapHeight) {
